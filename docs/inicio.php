    <main>
        <section id="welcome">
            <div class="welcomeContainer">
                ...
                <div class="centredTextInImage">
                    ...
                    <h5 class="fade-in">Estilo, descanso y ubicación ideal</h5>
                </div>
        ...
        <section class="info container">
            <div class="infoColumns">
                <h2 class="colorTitle fade-in">Nos renovamos para recibirte mejor</h2>
                <p class="fade-in">Con una ubicación privilegiada entre la tranquilidad de un barrio residencial y la cercanía al
        ...
        <section class="infoCards">
            <h3 class="colorTitle fade-in">¿Qué podemos ofrecerte?</h3>
            <div class="cards">
